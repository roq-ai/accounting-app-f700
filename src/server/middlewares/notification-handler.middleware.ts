...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'invoice.create': {
    roles: ['admin', 'tenant'],
    key: 'new-invoice-created',
    tenantPath: ['tenant', 'invoice'],
    userPath: [],
  },
  'expense.create': {
    roles: ['admin', 'tenant'],
    key: 'expense-recorded',
    tenantPath: ['tenant', 'expense'],
    userPath: [],
  },
  'bank_account.update': {
    roles: ['admin', 'tenant'],
    key: 'bank-account-updated',
    tenantPath: ['tenant', 'bank_account'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'accountant', 'viewer', 'tenant'];
